          ...
          <div className="contact-info">
            ...
            <div className="social-links">
              ...
              <div className="social-grid">
                <a href="https://github.com/rishugoyal805" target="_blank" className="social-link" aria-label="GitHub">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://www.linkedin.com/in/rishu0405" target="_blank" className="social-link" aria-label="LinkedIn">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
